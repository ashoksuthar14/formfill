...
if uploaded_file is not None:
    ...
    if st.button("Fill Form"):
        ...
        # Display the result
        st.success(f"Form filled successfully! Saved at: {filled_form_path}")
        st.download_button("Download Filled Form", open(filled_form_path, 'rb').read(), file_name="filled_form.pdf")
